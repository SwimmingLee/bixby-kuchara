...
module.exports.function = function makeDateTimeExpression (dateTimeExpression, detachedTime) {
  ...
  if(typeof dateTimeExpression != 'undefined'){
    dateTimeExpressionObj.dateTime.date.year = dateTimeExpression.dateTime.date.year;
    dateTimeExpressionObj.dateTime.date.month = dateTimeExpression.dateTime.date.month;
    dateTimeExpressionObj.dateTime.date.day = dateTimeExpression.dateTime.date.day;
  } 
